...
// -------------------------
// MF'in' Access 2000 fix.
// THANKS AGAIN, PAUL!!  See his MSJ article for details
// on the RIGHT (non-MS) way to fix this problem.
// Basically, you just include THIS file in your project,
// and these versions are called instead of the ones
// in the MFC libraries and dll's.

// MDM	1/24/2003 12:46:28 PM
// We pulled this 8/29/2001 version from the Microsoft SDK.
// Apparently they are shipping binaries that are newer than
// the code, since the code is broken.  It uses CLSID35_CDAODBEngine,
// which is no longer defined.  We manually changed it to 
// CLSID_CDAODBEngine way down in the code below.

#include <DBDAOID.H>					// For CLSID_CDAODBEngine - note that CLSID35_CDAODBEngine is no longer defined?!?
#include <afxdao.h>
#include "daoimpl.h"
...
void AFXAPI AfxDaoInit()
{
	...
	switch (bUseDao)
	{
		case 35:
			...
			// --------------------------------
			// MDM	1/24/2003 12:51:07 PM			
			// ACCESS 2000 FIX
			// The previous code define is no
			// longer available...rrr...
			// --------------------------------
...
// MDM	1/24/2003 12:52:12 PM
// We're not doing this in a library so this doesn't make sense.
// #pragma init_seg(lib)
