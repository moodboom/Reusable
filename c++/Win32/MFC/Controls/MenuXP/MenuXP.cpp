...
SimpleFont* CMenuXP::m_psfCustom = 0;
CFont			CMenuXP::m_cfCustom;
...
public:
    ...
    void Draw             (CDC* pDC, LPCRECT pRect, bool bSelected, bool bDisabled ) const;
};
...
void CMenuXP::SetCustomFont( SimpleFont& sf )
{ 
	m_psfCustom = &sf; 
	GetCFont(
		sf,
...
void CMenuXP::OnDrawItem (DRAWITEMSTRUCT* pDrawItemStruct)
{
    ...
    item.Draw(
		...
		(pDrawItemStruct->itemState & ( ODS_DISABLED /*| ODS_GRAYED*/ ) )!=0
	);
}
...
///////////////////////////////////////////////////////////////////////////////
void CMenuXP::SetWinXPStyle (CMenu* pMenu, CWnd* pWnd)
{
    ...
    int nHeight = max((int)tm.tmHeight+2,IMGHEIGHT)+4;
