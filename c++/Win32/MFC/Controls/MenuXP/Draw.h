...
// CDrawButton types
//
#define DB_EMPTY_BUT   0x0000 // Empty button	MDM NOTE: Changed from DB_EMPTY to avoid conflict in odbc.h
...
#define DB_DEFAULT DB_EMPTY_BUT
...
public:
    CDrawButton (DWORD wStyle = DB_EMPTY_BUT);
