...
#include <algorithm>							// For _MIN(), _MAX()
using namespace std;
...
CRoundSliderCtrl::CRoundSliderCtrl()
{
	...
	// m_hPointer = LoadCursor((_Module.GetResourceInstance(),MAKEINTRESOURCE (IDC_POINTER));
}
...
void CRoundSliderCtrl::Init()
{
	...
	rc.bottom = rc.right = _MIN(rc.bottom, rc.right);
...
void CRoundSliderCtrl::OnPaint() 
{
	...
	*/
	...
	{
		DrawCircle(pDC, m_ptCenter						, nRadius	, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
		DrawCircle(pDC, m_ptCenter + CSize( 0, 1 ), nRadius	, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
		DrawCircle(pDC, m_ptCenter - CSize( 1, 0 ), nRadius	, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	}
	DrawCircle(pDC, m_ptCenter						, nRadius + 1, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	DrawCircle(pDC, m_ptCenter + CSize( 0, 1 ), nRadius + 1, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	DrawCircle(pDC, m_ptCenter - CSize( 1, 0 ), nRadius + 1, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	DrawCircle(pDC, m_ptCenter						, nRadius + 2, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	DrawCircle(pDC, m_ptCenter + CSize( 0, 1 ), nRadius + 2, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
	DrawCircle(pDC, m_ptCenter - CSize( 1, 0 ), nRadius + 2, ::GetSysColor(COLOR_3DHIGHLIGHT),::GetSysColor(COLOR_3DDKSHADOW));
