...
namespace SimpleWeb {
    ...
    public:
        Server(boost::asio::io_service& ios, unsigned short port, size_t num_threads, const std::string& cert_file, const std::string& private_key_file,
            ...
            // 2016/08/21 Restrict ciphers to only modern versions that do not have security concerns atm.
            ...
            if (SSL_CTX_set_cipher_list(context.native_handle(), ciphers.c_str()) != 1) {
